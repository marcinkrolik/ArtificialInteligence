...
class QLearningAgent(ReinforcementAgent):
  ...
  def update(self, state, action, nextState, reward):
    ...
    sample = reward
    if nextStateActions:
        for nextStateAction in nextStateActions:
            tempList.append(self.getQValue(nextState, nextStateAction))
        sample = reward + self.discount * max(tempList)
...
class ApproximateQAgent(PacmanQAgent):
  ...
  def getQValue(self, state, action):
    ...
    for feature in features:
        tempList.append(self.weights[feature] * features[feature])
