...
def uniformCostSearch(problem):
    ...
    while fringe.isEmpty() == False:
        ...
        if node[0] not in visited:
            ...
            accumulatedCost = node[2]
            for successor in successors:
                pos, dir, cost = successor
                fringe.push((pos,node[1]+dir+' ',accumulatedCost+cost),accumulatedCost+cost)
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while fringe.isEmpty() == False:
        ...
        if node[0] not in visited:
            ...
            for successor in successors:
                pos, dir, cost = successor
                fringe.push((pos,node[1]+dir+' ',accumulatedCost+cost),accumulatedCost+cost+heuristic(node[0],problem))
